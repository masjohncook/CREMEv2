...
# install python 3.8
send "sudo apt install build-essential checkinstall -y \r"
expect "$path# "
send "sudo apt install libreadline-gplv2-dev libncursesw5-dev libsqlite3-dev tk-dev libgdbm-dev libc6-dev libbz2-dev -y \r"
expect "$path# "
send "sudo apt install libssl-dev libncurses5-dev libreadline-dev libgdm-dev libdb4o-cil-dev -y \r"
expect "$path# "
send "wget https://www.python.org/ftp/python/3.8.2/Python-3.8.2.tar.xz \r"
expect "$path# "
send "tar xvf Python-3.8.2.tar.xz \r"
expect "$path# "
send "cd Python-3.6.2/ \r"
expect "$path# "
send "./configure \r"
expect "$path/Python-3.6.2/# "
send "sudo make \r"
expect "$path/Python-3.6.2/# "
...
send "cd .. \r"
expect "$path# "
send "sudo update-alternatives --install /usr/bin/python python /usr/local/bin/python3.8 2 \r"
