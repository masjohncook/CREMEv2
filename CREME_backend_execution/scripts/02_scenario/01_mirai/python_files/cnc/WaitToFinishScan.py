...
def main(argv):
    if len(argv) != 7:
        print("Usage: {} Path ScanListenOutputFile.txt ScanFinishedFile.txt numOfNewBots Mirai-Source-Code/01_mirai/debug input_bot".format(argv[0]))
    ...
    debug_path = argv[5]  # "Mirai-Source-Code/01_mirai/debug"
